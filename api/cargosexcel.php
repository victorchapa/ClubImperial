...
$tsaldo= 0;
    ...
    echo "<tr>";
    echo "<th><b>Socio</b></th>";
    echo "<th><b>Saldo anterior</b></th>";
    echo "<th><b>Saldo actual</b></th>";
    echo "</tr>";
    echo "<tr>";
    echo "<td>".$saldos[0]['Nombre']."</td>";
    echo "<td>$".$saldos[0]['SaldoAnt']."</td>";
    echo "<td>$".$saldos[0]['SaldoAct']."</td>";
    echo "</tr>";
    echo "</table>";
    echo "<p></p>";
	echo "<table cellspacing='0' cellpadding='1' border='1'>";
	...
	foreach($recibo as $r){
		echo "<tr><td>".$r["Dia"]."/".$r["Mes"]."/".$r["Year"]." ".$r["Hora"]."</td>";
		echo "<td>".$r["Servicio"]."</td>";
		echo "<td>$".$r["Cargo"]."</td>";
		$tcargo += $r["Cargo"];
		echo "<td>$".$r["Abono"]."</td>";
		$tabono += $r["Abono"];
